...
function researched(): ResearchedProduct {
  return {
    ...
    purpose: "Se usa como complemento diario.",
    audience: "Personas adultas.",
    subcategory: "Suplementos",
    keywords: "creatina, creatina monohidratada",
    vs_similares: [],
    serving_size: null,
    ...
    benefits: [
      ...
      {
        claim: "Complementa la ingesta diaria de magnesio",
        science_note: "El magnesio participa en la función muscular normal.",
      },
      {
        claim: "Se toma con una comida, sin preparar nada",
        science_note: "El fabricante indica una cápsula al día con alimentos.",
      },
    ],

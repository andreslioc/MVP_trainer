...
describe("database schema", () => {
  ...
  it("creates the required query and foreign-key indexes", async () => {
    const expectedIndexes = [
      ...
      "pretraining_activity_advisor_day_idx",
      "pretraining_activity_advisor_product_day_unique",
      "pretraining_activity_product_id_idx",
  ...
  it("preserves the required delete behavior and keeps advisors portable", async () => {
    const expected = new Map([
      ...
      ["pretraining_activity_advisor_id_advisors_id_fk", "c"],
      ["pretraining_activity_product_id_products_id_fk", "c"],
